...
export function FeedbackSuccessStep(props: FeedbackSuccessStepProps){
    return (
        <>
            ...
            <div className="flex flex-col items-center py-4 w-[304px]">
            ...
            <button
            className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent leading-6 hover:bg-zinc-700 transition-colors focus:ring-brand-500 focus:ring-1 resize-none focus:outline-none"
